<script lang="ts">
    ...
    let loadingclass: string = "bg-orange-500 scale-110 active:bg-orange-500";
    let successclass: string = "bg-red-500 scale-110 shake active:bg-red-500";
    let failedclass: string = "bg-green-500 scale-110 active:bg-green-500";
